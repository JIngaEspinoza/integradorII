...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    function EstadoCuentaDetallado($InputParameter)
    {
        ...
        //for ($anio = $anio_ini; $anio <= $anio_fin ; $anio++){ 
            ...
            $query = "execute [visa].[Listado_ProgramacionCurso] 1, '$number_month', '$anio' ";
     ...
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['catastral'] = $row['NombreCurso'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['tributo'] = $row['V_RESTRA'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['periodo'] = $row['c_periodo'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['fecha_vencimiento'] = $row['d_fecven'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['insoluto'] = number_format($row['n_impins'],2);
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['monto_ajustado'] = number_format($row['reajuste'],2);
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['mora'] = number_format($row['mora'],2);
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['costo'] = number_format($row['n_costem'],2);
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['total'] = number_format($row['total'],2);
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['id'] = $row['CodigoPC'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['direccion_predio'] = $row['Direccion_Predio'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['uso'] = $row['Uso_rentas'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['situacion'] = $row['Situacion'];
					// $contenedor[$sedecont]['detallado'][$descri][$b]['coactivo'] = $row['ID_COAC'];

     //                $contenedor[$sedecont]['detallado'][$descri][$b]['CodigoPC'] = $row['CodigoPC'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['IdSede'] = $row['IdSede'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['NombreSede'] = $row['NombreSede'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['NombreModalidad'] = $row['NombreModalidad'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['rango_edad'] = $row['rango_edad'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['E_desde'] = $row['E_desde'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['E_hasta'] = $row['E_hasta'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['NombreCurso'] = $row['NombreCurso'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['DescripcionD'] = $row['DescripcionD'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['Hora'] = $row['Hora'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['NombreAmbiente'] = $row['NombreAmbiente'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['vrazonsocial'] = $row['vrazonsocial'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['NAlumnosMAx'] = $row['NAlumnosMAx'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['NAlumnosMin'] = $row['NAlumnosMin'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['Inicio'] = $row['Inicio'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['Fin'] = $row['Fin'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['vacantes'] = $row['vacantes'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['estado'] = $row['estado'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['CodigoPeriodo'] = $row['CodigoPeriodo'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['Modalidad'] = $row['Modalidad'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['Especialidad'] = $row['Especialidad'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['CodigoCurso'] = $row['CodigoCurso'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['CodigoProfesor'] = $row['CodigoProfesor'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['CodigoAmbiente'] = $row['CodigoAmbiente'];
     //                $contenedor[$sedecont]['detallado'][$descri][$b]['CodigoDia'] = $row['CodigoDia'];
     //                $b++;
                }
                $puntero++;
            }
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    function NombreCurso($InputParameter)
    {
        ...
        $hoy = date('Y-m-d');
        $idsede_new = $InputParameter['idsede_new'];
        $query = "execute [visa].[Listado_ProgramacionCurso] 2, '','$anio', '$idsede_new' ";
        $execute = mssql_query($query,$conexion);
